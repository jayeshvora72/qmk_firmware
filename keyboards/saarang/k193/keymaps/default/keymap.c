...
[BASE] = LAYOUT_k19(
  ...
  KC_CAPS,                TG(MEDIA), KC_PSCR, KC_PGDN,      KC_END,    KC_PAUS, TG(NUMBER),                     KC_APP,
         ...
         KC_Z,  KC_X,  KC_C,  KC_V,  KC_B, OSM(MOD_LALT),   OSM(MOD_RGUI),KC_N, KC_M,  KC_COMM, KC_DOT, KC_SLASH,           KC_P1,   KC_P2,   KC_P3,   KC_ENT,
       KC_MINS,KC_QUOT,KC_EQL,      KC_SPC,OSM(MOD_LSFT),   OSM(MOD_RSFT),KC_SPC,               KC_UP,                      KC_P0,            KC_PDOT,
               KC_BSLS,                    OSM(MOD_LCTL),   OSL(SYMBOL),              KC_LEFT,  KC_DOWN,KC_RIGHT
),
...
[SYMBOL] = LAYOUT_k19(
  ...
  ____,                            ____,    ____, ____,    ____, ____, ____,                   ____,
         ...
         ____,   KC_TILD, KC_LCBR, KC_RCBR, ____, ____,    ____, ____, ____, ____, ____, ____,          ____, ____, ____, ____,
         ____,   KC_GRV,  KC_LBRC, KC_RBRC, ____, ____,    ____, ____, ____, ____, ____, ____,          ____, ____, ____, ____,
         ____,   ____,    ____,    ____,    ____, ____,    ____, ____, ____, ____, ____, ____,          ____, ____, ____, ____,
         ____,   ____,    ____,             ____, ____,    ____, ____,             ____,                ____,       ____,
                 ____,                            ____,    ____,             ____, ____, ____
),
