...
inline void k19_l2_led_on(void)         { writePinHigh(B4); }
inline void k19_l3_led_on(void)         { writePinHigh(E6); }
...
inline void k19_l2_led_off(void)        { writePinLow(B4); }
inline void k19_l3_led_off(void)        { writePinLow(E6); }
