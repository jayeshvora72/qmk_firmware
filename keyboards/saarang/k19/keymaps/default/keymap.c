 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Caps                      |Media |PrScr | PgDn |      | End  |Pause | Num                       | App  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 ...
 *        |------+------+------+------+------+------|      |------+------+------+------+------+------|
 *        |  Z   |  X   |  C   |  V   |  B   | Ctrl |      | Win  |  N   |  M   |  ,   |  .   |  /   |
 *        |------+------+------+------+------+------|      |------+------+------+------+------+------|
 *        |  -   |  '          | alt  |Space | Shft |      | SpCh |Space               |  Up  |
 *        |------+------+------+------+------+------|      |------+------+------+------+------+------|
 *                                                                               |Left | Down | Right|
 *                                                                               |-----+------+------|
 *
...
[BASE] = LAYOUT_k19(
  ...
  KC_CAPS,                TG(MEDIA), KC_PSCR, KC_PGDN,      KC_END,    KC_PAUS, TG(NUMBER),                     KC_APP,
         KC_1,  KC_2,  KC_3,  KC_4,  KC_5,  KC_ESC,         KC_INS,    KC_6,    KC_7,  KC_8,    KC_9,   KC_0,
         ...
         KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,  OSM(MOD_LCTL),  KC_RWIN,   KC_N,    KC_M,  KC_COMM, KC_DOT, KC_SLASH,
       KC_MINS,KC_QUOT,OSM(MOD_LALT),KC_SPC,OSM(MOD_LSFT),  OSL(SPCH), KC_SPC,                  KC_UP,
